  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      description:
        "Built AI-driven applications leveraging LLMs, Generative AI, and NLP techniques for advanced automation. Optimized model inference pipelines, reducing latency by 15% to enhance performance. Developed end-to-end solutions integrating AI-powered automation to improve workflow efficiency.",
    },
    {
